...
std_est1 = sqrt(2*total_rank1/(n*p))
std_est2 = sqrt(2*total_rank2/(n*p))
...
save(signal1_list, signal2_list, X1_list, X2_list, J1r_list, J2r_list, 
     J1c_list, J2c_list, total_rank1, total_rank2, joint_rank_col, joint_rank_row, file = "Simulations/SimulationData_Setting2/Data.RData")
