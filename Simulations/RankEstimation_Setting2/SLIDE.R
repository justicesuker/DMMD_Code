...
load("Simulations/SimulationData_Setting2/Data.RData")
set.seed(37)
...
stopCluster(cl)
save(output,total_rank1,total_rank2,joint_rank_col,joint_rank_row, file = "Simulations/RankEstimation_Setting2/SLIDEoutput.RData")
