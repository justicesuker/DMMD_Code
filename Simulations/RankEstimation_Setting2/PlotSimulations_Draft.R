...
pdf(file = paste(fig.path,"Comparison on Joint Rank Estimation_Setting2.pdf",sep=""), width = 5, height = 4)
print(gg_joint)
dev.off()

pdf(file = paste(fig.path,"Comparison on Total Rank Estimation_Setting2.pdf",sep=""), width = 5, height = 4)
print(gg_total)
dev.off()
