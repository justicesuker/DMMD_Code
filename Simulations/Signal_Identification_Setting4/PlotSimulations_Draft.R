rm(list = ls())
load("Simulations/Signal_Identification_Setting4/SLIDEoutput.RData")
output_slide = output
rm(output)
load("Simulations/Signal_Identification_Setting4/AJIVE_output.RData")
output_ajive = output
rm(output)
load("Simulations/Signal_Identification_Setting4/output.RData")
...
boxplot(my_signal_error1, jive_row_error1, slide_col_error1, slide_row_error1, ajive_col_error1)
...
# Draw boxplot
fig.path = "Simulations/Signal_Identification_Setting4/Figures/Draft/"
pdf(file = paste(fig.path,"Signal Identification for Row Decomposition_All_Setting4.pdf",sep=""), width = 10, height = 8)
print(gg_row)
dev.off()

pdf(file = paste(fig.path,"Signal Identification for Column Decomposition_All_Setting4.pdf",sep=""), width = 10, height = 8)
print(gg_col)
dev.off()
