...
# The function that finds the solution of a simplified version of the optimization problem problem (1) in the manuscript. 
# Simplified case means either the rank of M or N equal to the specified rank r.
