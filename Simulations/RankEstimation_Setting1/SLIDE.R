...
load("Simulations/SimulationData_Setting1/Data.RData")
...
stopCluster(cl)
save(output,total_rank1,total_rank2,joint_rank_col,joint_rank_row, file = "Simulations/RankEstimation_Setting1/SLIDEoutput.RData")
